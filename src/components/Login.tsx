...
export function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-black flex items-center justify-center px-4 relative overflow-hidden">
      ...
      >
        ...
        >
          ...
          {!showEmailLogin && <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ delay: 0.3 }}
            className="text-2xl sm:text-2xl mb-8 bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent text-center"
          >
